...
public class QnaPost implements MouseListener{
	   JPanel contentPane;
	   ...
	   int no=0;//글번호
	   int pageCnt=0;
	   public QnaPost(int no,String title,String id,int like,int viewCnt,String date)   {
	      ...
	      updateSaveBtn.addActionListener(new ActionListener() {
	         public void actionPerformed(ActionEvent e) {
	            ...
	            ModifyPostPane modiPane=new ModifyPostPane(0,no,QnaVO.getQnaTitle(),qbVO.getQnaContent(),true);
	      ...
	      if(!AdminMain.mvo.getMemId().equals(id)) {
	         ...
	         if(qbd.isThereQnaBoard(AdminMain.mvo.getMemId(),no)==0) {
	               ...
	               public void mouseClicked(MouseEvent e) {
	                  ...
	                  if (qbDAO.updateLikeCnt(no)) {
	                     ...
	                     if (qbDAO.updateMemLike(id)) {
	                        ...
	                        if (qbDAO.insertLikeBoardNo(AdminMain.mvo.getMemId(), no)) {
	      ...
	      wirteCmtBtn.addActionListener(new ActionListener() {
	         public void actionPerformed(ActionEvent e) {
	            ...
	            if(qcDAO.writeQnaComt(no, lastnum+1,AdminMain.mvo.getMemId(),content)) {
	   ...
	   class CustomCmtPane extends JPanel {
	      ...
	      public CustomCmtPane(int qnaNo,int comtNo,String memId,String content,int like,String date) {
	         ...
	         {   
	            ...
	            if(qcomtDao.isThereQnaComt(AdminMain.mvo.getMemId(), qnaNo, comtNo)==0) {
	                  ...
	                  public void actionPerformed(ActionEvent e) {
	                     ...
	                     if (qcomtDAO.updateLikeCnt(qnaNo,comtNo)) {
	                        ...
	                        if (qcomtDAO.updateMemLike(memIdLabel.getText())) {
	                           ...
	                           if (qcomtDAO.insertLikeBoardNo(AdminMain.mvo.getMemId(), qnaNo, comtNo)) {
	                              JOptionPane.showMessageDialog(null, "좋아요누른게시물 추가성공");
	                           } else {
	                              JOptionPane.showMessageDialog(null, "작성자 좋아요 수 높이기 실패");
	                           }
